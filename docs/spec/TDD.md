...
<!-- id: TDD-3.1.78 | implements: EN-44 | code: src/research_agent/tools/snapshot.py#authorize_snapshot, src/research_agent/storage/requests.py#PaperRequestRepository, src/research_agent/ingest/requests.py#acquire_requests | tests: tests/tools/test_paper_requests.py, tests/storage/test_requests.py, tests/ingest/test_requests.py | status: pending:#265 -->
