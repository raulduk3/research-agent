...
<!-- id: TDD-2.1.20 | implements: SR-17 | code: src/research_agent/platform/readiness.py#LayerAdmission, src/research_agent/platform/reports.py#admit_activation | tests: tests/platform/test_layer_admission.py, tests/platform/test_readiness.py, tests/storage/test_reports.py | status: implemented -->
