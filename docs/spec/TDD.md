...
<!-- id: TDD-4.1.79 | implements: IN-43 | code: src/research_agent/measurement/preference.py#credit_ratings, src/research_agent/storage/preference.py#PreferenceRepository | tests: tests/measurement/test_preference.py, tests/contracts/test_preference_credit.py, tests/storage/test_preference_credit.py | status: implemented -->
