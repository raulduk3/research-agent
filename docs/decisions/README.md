...
| Frozen Qwen embedding d=1024; title/abstract plus pooled original full-paper input [2048]; output, labels and masks [N,3] | [0006](0006-adopt-full-paper-passage-retrieval.md), [0008](0008-finalize-launch-operating-profile.md); MD-06; FT-08, FT-09 |
...
| Eight Jev original-paper assessments, separate human qualification, no human semantic prediction-head labels | [0004](0004-adopt-jev-launch-assessments.md); RD-15 to RD-24; SDD Appendix A |
...
| Specification states design only; project status lives in issues and implementation and evidence records | [0011](0011-keep-project-status-out-of-the-specification.md) |
