...
| The launch Jev rubric in choice, score and noul questions, v1 kept for its stored assessments; cards render only what reads each value | [0026](0026-jev-rubric-v2.md); RD-16, RD-18, RD-22 |
...
| Short-horizon registered targets (rater_like_7d, early_citation_rank_60d, venue_180d) beside the three citation targets; year-one fitness is skill over a genome's resolved registered targets, minimum resolved-claim count 30, island proxy below it; a grounding floor of 0.95 over the last 30 sealed claims gates parent/survivor eligibility | [0023](0023-short-horizon-targets-and-year-one-fitness.md); SR-09, AG-19, AG-26, FT-14, FT-27; SDD Appendix A, Appendix B |
...
| One ingress publishing the owner surfaces alone through an authenticated tunnel; the rating app and internal services never published; one named front-end origin; per-role limits in Compose and batch thresholds from the guest's memory | [0030](0030-publish-owner-surfaces-only.md); SDD Appendix A; TDD-2.1.32 |
